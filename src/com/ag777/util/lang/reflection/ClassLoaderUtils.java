 ...
 * 
 * <p>
 * <code>ClassLoaderUtils</code>查找类和资源的效果， 相当于<code>ClassLoader.loadClass</code> 方法和<code>ClassLoader.getResource</code>
 * 方法。 但<code>ClassLoaderUtils</code> 总是首先尝试从<code>Thread.getContextClassLoader()</code>方法取得 <code>ClassLoader</code>
 ...
 * 
 * <p>
 * 注意，<code>Thread.getContextClassLoader()</code>是在JDK1.2之后才有的，对于低版本的JDK， <code>ClassLoaderUtils</code>的效果和直接调用
...
public class ClassLoaderUtils {
    ...
    public static String getClasspath() {
        return ClassLoaderUtils.getResource("").getPath();
    }
    ...
    /**
     * 从指定的<code>ClassLoader</code>中装入类。如果未指定<code>ClassLoader</code>， 则从装载 <code>ClassLoaderUtils</code>的
     * <code>ClassLoader</code>中装入。
     * 
     * @param className 要装入的类名
     * @param classLoader 从指定的<code>ClassLoader</code>中装入类，如果为<code>null</code>，表示从 <code>ClassLoaderUtils</code>所在的class
     *            loader中装载
     * 
     * @return 已装入的类
     * 
     ...
     * 
     * @param serviceId 服务名
     * @param referrer 调用者类，如果为<code>null</code>，表示在<code>ClassLoaderUtils</code> 的class loader中找。
     * 
     * @return service class
     * 
     * @throws ClassNotFoundException 如果service class找不到，或装载service文件失败
     ...
     * 
     * @param serviceId 服务名
     * @param classLoader 在指定classLoader中查找，如果为<code>null</code>，表示在 <code>ClassLoaderUtils</code>的class loader中找。
     * 
     * @return service class
     * 
     * @throws ClassNotFoundException 如果service class找不到，或装载service文件失败
    ...
    public static <T> Class<T> loadServiceClass(String serviceId, ClassLoader classLoader)
        ...
        return ClassLoaderUtils.loadClass(serviceClassName, classLoader);
    }
     ...
     * 
     * @param className 要实例化的类名
     * @param referrer 调用者类，如果为<code>null</code>，则从<code>ClassLoaderUtils</code> 所在的class loader装载
     * 
     * @return 指定类名的实例
     * 
     * @throws ClassNotFoundException 如果类没找到
    ...
    /**
     * 从指定的<code>ClassLoader</code>中装入类并实例化之。如果未指定<code>ClassLoader</code>， 则从装载 <code>ClassLoaderUtils</code>的
     * <code>ClassLoader</code>中装入。
     * 
     * @param className 要实例化的类名
     * @param classLoader 从指定的<code>ClassLoader</code>中装入类，如果为<code>null</code>，表示从 <code>ClassLoaderUtils</code>所在的class
    ...
    /**
     * 从指定的<code>ClassLoader</code>中取得所有resource URL。如果未指定 <code>ClassLoader</code>， 则从装载<code>ClassLoaderUtils</code>的
    ...
    public static URL getResource(String resourceName, Class<?> referrer) {
        ...
        return (classLoader == null) ? ClassLoaderUtils.class.getClassLoader().getResource(resourceName) : classLoader
