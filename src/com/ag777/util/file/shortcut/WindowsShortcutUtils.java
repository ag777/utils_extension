package com.ag777.util.file.shortcut;
 ...
 * <p>用于解析lnk(windows快捷方式)文件,只读
 * @author https://github.com/codebling/WindowsShortcuts/blob/master/src/main/java/org/stackoverflowusers/file/WindowsShortcut.java
 */
public class WindowsShortcutUtils
{
    ...
    public WindowsShortcutUtils(final File file) throws IOException, ParseException {
